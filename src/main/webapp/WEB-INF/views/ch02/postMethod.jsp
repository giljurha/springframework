...
<div class="card">
	...
	<div class="card-body">
		...
		<div class="mt-2">
			...
			<button onclick="requestPost1()" class="btn btn-info btn-sm mb-2">Javascript: HTML 조각 이용</button>
			<button onclick="requestPost2()" class="btn btn-info btn-sm mb-2">Javascript: JSON 이용</button>
