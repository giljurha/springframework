	...
	<div class="accordion-item">
	   <h2 class="accordion-header">
	      <button class="accordion-button ${chNum=='ch09'?'':'collapsed'}" type="button"
	         data-bs-toggle="collapse" data-bs-target="#ch09"
	         aria-expanded="${chNum=='ch09'}" aria-controls="ch09">
	         Ch09. 파일 업로드와 다운로드
        	</button>
	   </h2>
	   <div id="ch09" class="accordion-collapse collapse ${chNum=='ch09'?'show':''}"
	      data-bs-parent="#accordionMenu">
	      <div class="accordion-body">
	         <ul>
	...
	<div class="accordion-item">
	   <h2 class="accordion-header">
	      <button class="accordion-button ${chNum=='ch10'?'':'collapsed'}" type="button"
	         data-bs-toggle="collapse" data-bs-target="#ch10"
	         aria-expanded="${chNum=='ch10'}" aria-controls="ch10">
	         Ch10. 예외 처리
        	</button>
	   </h2>
	   <div id="ch10" class="accordion-collapse collapse ${chNum=='ch10'?'show':''}"
	      data-bs-parent="#accordionMenu">
	      <div class="accordion-body">
	         <ul>
	...
	<div class="accordion-item">
	   <h2 class="accordion-header">
	      <button class="accordion-button ${chNum=='ch11'?'':'collapsed'}" type="button"
	         data-bs-toggle="collapse" data-bs-target="#ch11"
	         aria-expanded="${chNum=='ch11'}" aria-controls="ch11">
	         Ch11. 국제화(다국어) 처리
        	</button>
	   </h2>
	   <div id="ch11" class="accordion-collapse collapse ${chNum=='ch11'?'show':''}"
	      data-bs-parent="#accordionMenu">
	      <div class="accordion-body">
	         <ul>
	...
	<div class="accordion-item">
	   <h2 class="accordion-header">
	      <button class="accordion-button ${chNum=='ch12'?'':'collapsed'}" type="button"
	         data-bs-toggle="collapse" data-bs-target="#ch12"
	         aria-expanded="${chNum=='ch12'}" aria-controls="ch12">
	         Ch12. 의존성 주입(DI)
        	</button>
	   </h2>
	   <div id="ch12" class="accordion-collapse collapse ${chNum=='ch12'?'show':''}"
	      data-bs-parent="#accordionMenu">
	      <div class="accordion-body">
	         <ul>
